...
type MultiplierClient interface {
	Myltiply(ctx context.Context, in *MyltiplyRequest, opts ...grpc.CallOption) (*MyltiplyResponse, error)
}
...
func (c *multiplierClient) Myltiply(ctx context.Context, in *MyltiplyRequest, opts ...grpc.CallOption) (*MyltiplyResponse, error) {
	out := new(MyltiplyResponse)
	err := c.cc.Invoke(ctx, "/Multiplier/Myltiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MultiplierServer interface {
	Myltiply(context.Context, *MyltiplyRequest) (*MyltiplyResponse, error)
...
func (UnimplementedMultiplierServer) Myltiply(context.Context, *MyltiplyRequest) (*MyltiplyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Myltiply not implemented")
}
...
func _Multiplier_Myltiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyltiplyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultiplierServer).Myltiply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Multiplier/Myltiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultiplierServer).Myltiply(ctx, req.(*MyltiplyRequest))
	}
...
var Multiplier_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Myltiply",
			Handler:    _Multiplier_Myltiply_Handler,
		},
	},
